...
class KeysViewModel @Inject constructor(
    ...
    fun showGenerateDialog() { _uiState.update { it.copy(showGenerateDialog = true, newName = "", error = null, tip = null) } }
    fun hideGenerateDialog() { _uiState.update { it.copy(showGenerateDialog = false) } }
    fun showImportDialog() { _uiState.update { it.copy(showImportDialog = true, importName = "", importPublicKey = "", importPrivateKey = "", importFileUri = null, error = null, tip = null) } }
    ...
    private fun doImportFromFields(state: KeysUiState) {
        ...
        viewModelScope.launch {
            try {
                ...
                _uiState.update { it.copy(showImportDialog = false, importFileUri = null, success = null, tip = "密钥已导入") }
            } catch (e: Exception) {
